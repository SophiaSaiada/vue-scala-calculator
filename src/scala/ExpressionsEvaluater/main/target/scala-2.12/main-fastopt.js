...
function $is_LBaseExpression(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LBaseExpression)))
}
function $as_LBaseExpression(obj) {
  return (($is_LBaseExpression(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "BaseExpression"))
}
function $isArrayOf_LBaseExpression(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LBaseExpression)))
}
function $asArrayOf_LBaseExpression(obj, depth) {
  return (($isArrayOf_LBaseExpression(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LBaseExpression;", depth))
}
var $d_LBaseExpression = new $TypeData().initClass({
  LBaseExpression: 0
}, true, "BaseExpression", {
  LBaseExpression: 1
});
...
function $is_LExpressionWithChildren(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LExpressionWithChildren)))
}
function $as_LExpressionWithChildren(obj) {
  return (($is_LExpressionWithChildren(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "ExpressionWithChildren"))
}
function $isArrayOf_LExpressionWithChildren(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LExpressionWithChildren)))
}
function $asArrayOf_LExpressionWithChildren(obj, depth) {
  return (($isArrayOf_LExpressionWithChildren(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LExpressionWithChildren;", depth))
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
function $f_sc_TraversableOnce__product__s_math_Numeric__O($thiz, num) {
  return $thiz.foldLeft__O__F2__O(num.fromInt__I__O(1), new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function($this, num$1) {
    return (function(x$2, y$2) {
      return num$1.times__O__O__O(x$2, y$2)
    })
  })($thiz, num)))
}
...
/** @constructor */
function $c_LTreeBuilderAndEvaluator$() {
  $c_O.call(this);
  this.constants$1 = null;
  this.operationsDefinitions$1 = null;
  this.t$1 = null;
...
$c_LTreeBuilderAndEvaluator$.prototype = new $h_O();
$c_LTreeBuilderAndEvaluator$.prototype.constructor = $c_LTreeBuilderAndEvaluator$;
/** @constructor */
function $h_LTreeBuilderAndEvaluator$() {
  /*<skip>*/
}
$h_LTreeBuilderAndEvaluator$.prototype = $c_LTreeBuilderAndEvaluator$.prototype;
$c_LTreeBuilderAndEvaluator$.prototype.referencesRestore__LBaseExpression__ALBaseExpression__LBaseExpression = (function(node, stackTrees) {
  if ($is_LIdentityExpression(node)) {
    var x2 = $as_LIdentityExpression(node);
    if (x2.isReference$1) {
      var array = [stackTrees.get($doubleToInt(x2.value$1))];
      var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array);
      var len = $uI(xs.array$6.length);
      var array$1 = $newArrayObject($d_LBaseExpression.getArrayOf(), [len]);
      var elem$1 = 0;
      elem$1 = 0;
      ...
      var x$25 = $m_LOperation$().Identity$2;
      var selfUpdated = new $c_LBracketsExpression().init___s_Enumeration$Value__ALBaseExpression(x$25, array$1)
    } else {
      var selfUpdated = node
    }
  } else {
    var selfUpdated = node
  };
  if ($is_LExpressionWithChildren(selfUpdated)) {
    var x2$2 = $as_LExpressionWithChildren(selfUpdated);
    var xs$1 = x2$2.arguments__ALBaseExpression();
    var elems$2 = null;
    elems$2 = [];
    ...
    while ((i < len$1)) {
      ...
      var arg = $as_LBaseExpression(arg1$1);
      var elem = $m_LTreeBuilderAndEvaluator$().referencesRestore__LBaseExpression__ALBaseExpression__LBaseExpression(arg, stackTrees);
      var unboxedElem = ((elem === null) ? null : elem);
      elems$2.push(unboxedElem);
      i = ((1 + i) | 0)
    };
    var updatedArguments = $makeNativeArrayWrapper($d_LBaseExpression.getArrayOf(), elems$2);
    var argumentsUpdated = x2$2.copy__ALBaseExpression__LExpressionWithChildren(updatedArguments)
  } else {
    var argumentsUpdated = selfUpdated
  };
  return argumentsUpdated
});
$c_LTreeBuilderAndEvaluator$.prototype.init___ = (function() {
  $n_LTreeBuilderAndEvaluator$ = this;
  $f_s_App__$$init$__V(this);
  var body = new $c_LTreeBuilderAndEvaluator$delayedInit$body().init___LTreeBuilderAndEvaluator$(this);
  this.scala$App$$initCode$1.$$plus$eq__O__scm_ListBuffer(body);
  return this
});
$c_LTreeBuilderAndEvaluator$.prototype.delayedEndpoint$TreeBuilderAndEvaluator$1__V = (function() {
  var jsx$1 = $m_sci_ListMap$();
  var array = [new $c_T2().init___O__O("\u03c0", 3.141592653589793), new $c_T2().init___O__O("e", 2.718281828459045)];
  this.constants$1 = $as_sci_ListMap(jsx$1.apply__sc_Seq__sc_GenMap(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array)));
  var jsx$23 = $m_sci_ListMap$();
  var self = $m_LOperation$().Factorial$2;
  var $$this = self;
  var jsx$21 = $m_s_Array$();
  var array$1 = [];
  var y = new $c_LOperationDefinition().init___T__AI__F1("!", jsx$21.apply__I__sc_Seq__AI((-1), new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1)), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(arguments$2$2) {
      var arguments$2 = $asArrayOf_D(arguments$2$2, 1);
      var end = $doubleToInt(arguments$2.get(0));
      var this$13 = new $c_sci_Range$Inclusive().init___I__I__I(1, end, 1);
      var num = $m_s_math_Numeric$IntIsIntegral$();
      return $uI($f_sc_TraversableOnce__product__s_math_Numeric__O(this$13, num))
    })
  })(this)));
  var jsx$22 = new $c_T2().init___O__O($$this, y);
  var self$1 = $m_LOperation$().Ln$2;
  var $$this$1 = self$1;
  var jsx$19 = $m_s_Array$();
  var array$2 = [];
  var y$1 = new $c_LOperationDefinition().init___T__AI__F1("ln", jsx$19.apply__I__sc_Seq__AI(1, new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$2)), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2$1) {
    return (function(arguments$3$2) {
      var arguments$3 = $asArrayOf_D(arguments$3$2, 1);
      var a = arguments$3.get(0);
      return $uD($g.Math.log(a))
    })
  })(this)));
  var jsx$20 = new $c_T2().init___O__O($$this$1, y$1);
  var self$2 = $m_LOperation$().Sin$2;
  var $$this$2 = self$2;
  var jsx$17 = $m_s_Array$();
  var array$3 = [];
  var y$2 = new $c_LOperationDefinition().init___T__AI__F1("sin", jsx$17.apply__I__sc_Seq__AI(1, new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$3)), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$3$1) {
    return (function(arguments$4$2) {
      var arguments$4 = $asArrayOf_D(arguments$4$2, 1);
      var a$1 = arguments$4.get(0);
      return $uD($g.Math.sin(a$1))
    })
  })(this)));
  var jsx$18 = new $c_T2().init___O__O($$this$2, y$2);
  var self$3 = $m_LOperation$().Cos$2;
  var $$this$3 = self$3;
  var jsx$15 = $m_s_Array$();
  var array$4 = [];
  var y$3 = new $c_LOperationDefinition().init___T__AI__F1("cos", jsx$15.apply__I__sc_Seq__AI(1, new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$4)), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$4$1) {
    return (function(arguments$5$2) {
      var arguments$5 = $asArrayOf_D(arguments$5$2, 1);
      var a$2 = arguments$5.get(0);
      return $uD($g.Math.cos(a$2))
    })
  })(this)));
  var jsx$16 = new $c_T2().init___O__O($$this$3, y$3);
  var self$4 = $m_LOperation$().Tan$2;
  var $$this$4 = self$4;
  var jsx$13 = $m_s_Array$();
  var array$5 = [];
  var y$4 = new $c_LOperationDefinition().init___T__AI__F1("tan", jsx$13.apply__I__sc_Seq__AI(1, new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$5)), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$5$1) {
    return (function(arguments$6$2) {
      var arguments$6 = $asArrayOf_D(arguments$6$2, 1);
      var a$3 = arguments$6.get(0);
      return $uD($g.Math.tan(a$3))
    })
  })(this)));
  var jsx$14 = new $c_T2().init___O__O($$this$4, y$4);
  var self$5 = $m_LOperation$().Sqrt$2;
  var $$this$5 = self$5;
  var jsx$11 = $m_s_Array$();
  var array$6 = [];
  var y$5 = new $c_LOperationDefinition().init___T__AI__F1("\u221a", jsx$11.apply__I__sc_Seq__AI(1, new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$6)), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$6$1) {
    return (function(arguments$7$2) {
      var arguments$7 = $asArrayOf_D(arguments$7$2, 1);
      var a$4 = arguments$7.get(0);
      return $uD($g.Math.sqrt(a$4))
    })
  })(this)));
  var jsx$12 = new $c_T2().init___O__O($$this$5, y$5);
  var self$6 = $m_LOperation$().Pow$2;
  var $$this$6 = self$6;
  var jsx$9 = $m_s_Array$();
  var array$7 = [1];
  var y$6 = new $c_LOperationDefinition().init___T__AI__F1("^", jsx$9.apply__I__sc_Seq__AI((-1), new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$7)), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$7$1) {
    return (function(arguments$8$2) {
      var arguments$8 = $asArrayOf_D(arguments$8$2, 1);
      var a$5 = arguments$8.get(0);
      var b = arguments$8.get(1);
      return $uD($g.Math.pow(a$5, b))
    })
  })(this)));
  var jsx$10 = new $c_T2().init___O__O($$this$6, y$6);
  var self$7 = $m_LOperation$().Div$2;
  var $$this$7 = self$7;
  var jsx$7 = $m_s_Array$();
  var array$8 = [1];
  var y$7 = new $c_LOperationDefinition().init___T__AI__F1("\u00f7", jsx$7.apply__I__sc_Seq__AI((-1), new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$8)), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$8$1) {
    return (function(x$2) {
      var x = $asArrayOf_D(x$2, 1);
      var this$49 = new $c_scm_ArrayOps$ofDouble().init___AD(x);
      ...
      return $uD($f_sc_IndexedSeqOptimized__reduceLeft__F2__O(this$49, op))
    })
  })(this)));
  var jsx$8 = new $c_T2().init___O__O($$this$7, y$7);
  var self$8 = $m_LOperation$().Mul$2;
  var $$this$8 = self$8;
  var jsx$5 = $m_s_Array$();
  var array$9 = [1];
  var y$8 = new $c_LOperationDefinition().init___T__AI__F1("\u00d7", jsx$5.apply__I__sc_Seq__AI((-1), new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$9)), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$9$1) {
    return (function(x$3$2) {
      var x$3 = $asArrayOf_D(x$3$2, 1);
      var this$55 = new $c_scm_ArrayOps$ofDouble().init___AD(x$3);
      var num$1 = $m_s_math_Numeric$DoubleIsFractional$();
      return $uD($f_sc_TraversableOnce__product__s_math_Numeric__O(this$55, num$1))
    })
  })(this)));
  var jsx$6 = new $c_T2().init___O__O($$this$8, y$8);
  var self$9 = $m_LOperation$().Sub$2;
  var $$this$9 = self$9;
  var jsx$3 = $m_s_Array$();
  var array$10 = [1];
  var y$9 = new $c_LOperationDefinition().init___T__AI__F1("-", jsx$3.apply__I__sc_Seq__AI((-1), new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$10)), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$10$1) {
    return (function(x$4$2) {
      var x$4 = $asArrayOf_D(x$4$2, 1);
      var this$61 = new $c_scm_ArrayOps$ofDouble().init___AD(x$4);
      var op$1 = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function($this$2) {
        return (function(x$3$2$1, x$4$2$1) {
          var x$3$1 = $uD(x$3$2$1);
          var x$4$1 = $uD(x$4$2$1);
          return (x$3$1 - x$4$1)
        })
      })(this$10$1));
      return $uD($f_sc_IndexedSeqOptimized__reduceLeft__F2__O(this$61, op$1))
    })
  })(this)));
  var jsx$4 = new $c_T2().init___O__O($$this$9, y$9);
  var self$10 = $m_LOperation$().Add$2;
  var $$this$10 = self$10;
  var jsx$2 = $m_s_Array$();
  var array$11 = [1];
  var y$10 = new $c_LOperationDefinition().init___T__AI__F1("+", jsx$2.apply__I__sc_Seq__AI((-1), new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$11)), new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$11$1) {
    return (function(x$5$2) {
      var x$5 = $asArrayOf_D(x$5$2, 1);
      var this$67 = new $c_scm_ArrayOps$ofDouble().init___AD(x$5);
      var num$2 = $m_s_math_Numeric$DoubleIsFractional$();
      return $uD($f_sc_TraversableOnce__sum__s_math_Numeric__O(this$67, num$2))
    })
  })(this)));
  var array$12 = [jsx$22, jsx$20, jsx$18, jsx$16, jsx$14, jsx$12, jsx$10, jsx$8, jsx$6, jsx$4, new $c_T2().init___O__O($$this$10, y$10)];
  this.operationsDefinitions$1 = $as_sci_ListMap(jsx$23.apply__sc_Seq__sc_GenMap(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$12)));
  this.t$1 = this.buildTreeFromString__T__LBaseExpression("3+(4^2+2531^cos(1\u00f73\u03c0)\u00f7(4+2))\u00d76")
});
$c_LTreeBuilderAndEvaluator$.prototype.buildTreeFromString__T__LBaseExpression = (function(query) {
  var array = [query];
  var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array);
  var len = $uI(xs.array$6.length);
  ...
  var stack = this.unwrapBrackets__AT__I__AT(array$1, 0);
  var elems$2 = null;
  elems$2 = [];
  var x1 = stack.u.length;
  switch (x1) {
    case (-1): {
      break
    }
  ...
  var i = 0;
  var len$1 = stack.u.length;
  while ((i < len$1)) {
    var index = i;
    var arg1$1 = stack.get(index);
    var expressionAsString = $as_T(arg1$1);
    var elem = $m_LTreeBuilderAndEvaluator$().parseString__T__ALBaseExpression(expressionAsString);
    var unboxedElem = ((elem === null) ? null : elem);
    elems$2.push(unboxedElem);
    i = ((1 + i) | 0)
  };
  var parsedStack = $makeNativeArrayWrapper($d_LBaseExpression.getArrayOf().getArrayOf(), elems$2);
  var elems$2$1 = null;
  elems$2$1 = [];
  var x1$1 = parsedStack.u.length;
  switch (x1$1) {
    case (-1): {
      break
    }
  ...
  var i$1 = 0;
  var len$2 = parsedStack.u.length;
  while ((i$1 < len$2)) {
    var index$1 = i$1;
    var arg1$2 = parsedStack.get(index$1);
    var parseString = $asArrayOf_LBaseExpression(arg1$2, 1);
    var elem$2 = $m_LTreeBuilderAndEvaluator$().buildTree__ALBaseExpression__sci_Map__ALBaseExpression(parseString, $m_LTreeBuilderAndEvaluator$().operationsDefinitions$1);
    var unboxedElem$1 = ((elem$2 === null) ? null : elem$2);
    elems$2$1.push(unboxedElem$1);
    i$1 = ((1 + i$1) | 0)
  };
  var xs$1 = $makeNativeArrayWrapper($d_LBaseExpression.getArrayOf().getArrayOf(), elems$2$1);
  var elems$2$2 = null;
  elems$2$2 = [];
  var x1$2 = xs$1.u.length;
  switch (x1$2) {
    case (-1): {
      break
    }
  ...
  var i$2 = 0;
  var len$3 = xs$1.u.length;
  while ((i$2 < len$3)) {
    var index$2 = i$2;
    var arg1$3 = xs$1.get(index$2);
    var tree = $asArrayOf_LBaseExpression(arg1$3, 1);
    var this$36 = new $c_scm_ArrayOps$ofRef().init___AO(tree);
    var elem$3 = $as_LBaseExpression($f_sc_IndexedSeqOptimized__head__O(this$36));
    var unboxedElem$2 = ((elem$3 === null) ? null : elem$3);
    elems$2$2.push(unboxedElem$2);
    i$2 = ((1 + i$2) | 0)
  };
  var stackTrees = $makeNativeArrayWrapper($d_LBaseExpression.getArrayOf(), elems$2$2);
  var this$38 = new $c_scm_ArrayOps$ofRef().init___AO(stackTrees);
  var resultTree = $as_LBaseExpression($f_sc_IndexedSeqOptimized__head__O(this$38));
  var replaceReferences = this.referencesRestore__LBaseExpression__ALBaseExpression__LBaseExpression(resultTree, stackTrees);
  return replaceReferences
});
$c_LTreeBuilderAndEvaluator$.prototype.buildTreeForOperationType__ALBaseExpression__T2__I__ALBaseExpression = (function(arrayOfExpressions, operation, fromIndex) {
  _buildTreeForOperationType: while (true) {
    var xs = arrayOfExpressions;
    var elems$2 = null;
    elems$2 = [];
    var len = xs.u.length;
    var i = 0;
    while ((i < len)) {
      var index = i;
      var elem = new $c_T2().init___O__O(xs.get(index), i);
      elems$2.push(elem);
      i = ((1 + i) | 0)
    };
    var xs$1 = $makeNativeArrayWrapper($d_T2.getArrayOf(), elems$2);
    var fromIndex$1 = fromIndex;
    var len$1 = xs$1.u.length;
    var i$1 = 0;
    while (true) {
      if ((i$1 < len$1)) {
        ...
        var expression = $as_LBaseExpression(x0$2.$$und1__O());
        var i$2 = x0$2.$$und2$mcI$sp__I();
        var x = expression.operation__s_Enumeration$Value();
        var x$2 = operation.$$und1__O();
        var jsx$1 = (!(((x === null) ? (x$2 === null) : x.equals__O__Z(x$2)) && (i$2 >= fromIndex$1)))
      } else {
        var jsx$1 = false
      };
      if (jsx$1) {
    ...
    var i$3 = i$1;
    var firstAppearanceOfOperation = ((i$3 < xs$1.u.length) ? new $c_s_Some().init___O(xs$1.get(i$3)) : $m_s_None$());
    if (firstAppearanceOfOperation.isDefined__Z()) {
      var firstAppearanceOfOperationIndex = $as_T2(firstAppearanceOfOperation.get__O()).$$und2$mcI$sp__I();
      var xs$2 = $as_LOperationDefinition(operation.$$und2__O()).argumentsOffsets$1;
      var arrayOfExpressions$1 = arrayOfExpressions;
      var elems$2$1 = null;
      elems$2$1 = [];
      var x1 = xs$2.u.length;
      switch (x1) {
        case (-1): {
          break
        }
      ...
      while ((i$4 < len$2)) {
        var idx = i$4;
        var arg1$1 = xs$2.get(idx);
        var elem$1 = arrayOfExpressions$1.get(((firstAppearanceOfOperationIndex + arg1$1) | 0));
        var unboxedElem = ((elem$1 === null) ? null : elem$1);
        elems$2$1.push(unboxedElem);
        i$4 = ((1 + i$4) | 0)
      };
      var arguments$2 = $makeNativeArrayWrapper($d_LBaseExpression.getArrayOf(), elems$2$1);
      var node = new $c_LExpression().init___s_Enumeration$Value__ALBaseExpression($as_s_Enumeration$Value(operation.$$und1__O()), arguments$2);
      var xs$3 = $as_LOperationDefinition(operation.$$und2__O()).argumentsOffsets$1;
      var currentLength = xs$3.u.length;
      var len$3 = ((1 + currentLength) | 0);
      var result = $newArrayObject($d_I.getArrayOf(), [len$3]);
      $m_s_Array$().copy__O__I__O__I__I__V(xs$3, 0, result, 0, currentLength);
      result.set(currentLength, 0);
      var elems$2$2 = null;
      elems$2$2 = [];
      var x1$1 = result.u.length;
      switch (x1$1) {
        case (-1): {
          break
        }
      ...
      var i$5 = 0;
      var len$4 = result.u.length;
      while ((i$5 < len$4)) {
        var idx$1 = i$5;
        var arg1$2 = result.get(idx$1);
        var elem$2 = ((firstAppearanceOfOperationIndex + arg1$2) | 0);
        elems$2$2.push(elem$2);
        i$5 = ((1 + i$5) | 0)
      };
      var affectedIndices = $makeNativeArrayWrapper($d_I.getArrayOf(), elems$2$2);
      var xs$4 = arrayOfExpressions;
      var this$35 = new $c_scm_ArrayOps$ofInt().init___AI(affectedIndices);
      var cmp = $m_s_math_Ordering$Int$();
      var until = $uI($f_sc_TraversableOnce__min__s_math_Ordering__O(this$35, cmp));
      var x$1 = ((until > 0) ? until : 0);
      var y = xs$4.u.length;
      var hi = ((x$1 < y) ? x$1 : y);
      var size = ((hi > 0) ? hi : 0);
      var result$1 = $m_jl_reflect_Array$().newInstance__jl_Class__I__O($objectGetClass(xs$4).getComponentType__jl_Class(), size);
      if ((size > 0)) {
        $m_s_Array$().copy__O__I__O__I__I__V(xs$4, 0, result$1, 0, size)
      };
      var xs$5 = $asArrayOf_O(result$1, 1);
      var array = [node];
      var xs$6 = new $c_sjs_js_WrappedArray().init___sjs_js_Array(array);
      var len$5 = $uI(xs$6.array$6.length);
      var array$1 = $newArrayObject($d_LExpression.getArrayOf(), [len$5]);
      var elem$1$1 = 0;
      elem$1$1 = 0;
      var this$50 = new $c_sc_IndexedSeqLike$Elements().init___sc_IndexedSeqLike__I__I(xs$6, 0, $uI(xs$6.array$6.length));
      while (this$50.hasNext__Z()) {
        var arg1$3 = this$50.next__O();
        array$1.set(elem$1$1, arg1$3);
        elem$1$1 = ((1 + elem$1$1) | 0)
      };
      var elems$2$3 = null;
      elems$2$3 = [];
      var this$57 = new $c_scm_WrappedArray$ofRef().init___AO(array$1);
      this$57.length__I();
      var x1$2 = xs$5.u.length;
      switch (x1$2) {
        case (-1): {
          break
        }
      ...
      var i$6 = 0;
      var len$6 = xs$7.length__I();
      while ((i$6 < len$6)) {
        var arg1$4 = xs$7.apply__I__O(i$6);
        var unboxedElem$1 = ((arg1$4 === null) ? null : arg1$4);
        elems$2$3.push(unboxedElem$1);
        i$6 = ((1 + i$6) | 0)
      };
      var xs$8 = new $c_scm_WrappedArray$ofRef().init___AO(array$1);
      var i$7 = 0;
      var len$7 = xs$8.length__I();
      while ((i$7 < len$7)) {
        var arg1$5 = xs$8.apply__I__O(i$7);
        var unboxedElem$2 = ((arg1$5 === null) ? null : arg1$5);
        elems$2$3.push(unboxedElem$2);
        i$7 = ((1 + i$7) | 0)
      };
      var xs$9 = $makeNativeArrayWrapper($d_LBaseExpression.getArrayOf(), elems$2$3);
      var xs$10 = arrayOfExpressions;
      var this$64 = new $c_scm_ArrayOps$ofInt().init___AI(affectedIndices);
      var cmp$1 = $m_s_math_Ordering$Int$();
      var n = ((1 + $uI($f_sc_TraversableOnce__max__s_math_Ordering__O(this$64, cmp$1))) | 0);
      var until$1 = xs$10.u.length;
      var lo = ((n > 0) ? n : 0);
      var x$3 = ((until$1 > 0) ? until$1 : 0);
      var y$1 = xs$10.u.length;
      var hi$1 = ((x$3 < y$1) ? x$3 : y$1);
      var x$4 = ((hi$1 - lo) | 0);
      var size$2 = ((x$4 > 0) ? x$4 : 0);
      var result$2 = $m_jl_reflect_Array$().newInstance__jl_Class__I__O($objectGetClass(xs$10).getComponentType__jl_Class(), size$2);
      if ((size$2 > 0)) {
        $m_s_Array$().copy__O__I__O__I__I__V(xs$10, lo, result$2, 0, size$2)
      };
      var xs$11 = $asArrayOf_O(result$2, 1);
      var elems$2$4 = null;
      elems$2$4 = [];
      var this$80 = new $c_scm_WrappedArray$ofRef().init___AO(xs$11);
      this$80.length__I();
      var x1$3 = xs$9.u.length;
      switch (x1$3) {
        case (-1): {
          break
        }
      };
      var xs$12 = new $c_scm_WrappedArray$ofRef().init___AO(xs$9);
      var i$8 = 0;
      var len$8 = xs$12.length__I();
      while ((i$8 < len$8)) {
        var arg1$6 = xs$12.apply__I__O(i$8);
        var unboxedElem$3 = ((arg1$6 === null) ? null : arg1$6);
        elems$2$4.push(unboxedElem$3);
        i$8 = ((1 + i$8) | 0)
      };
      var xs$13 = new $c_scm_WrappedArray$ofRef().init___AO(xs$11);
      var i$9 = 0;
      var len$9 = xs$13.length__I();
      while ((i$9 < len$9)) {
        var arg1$7 = xs$13.apply__I__O(i$9);
        var unboxedElem$4 = ((arg1$7 === null) ? null : arg1$7);
        elems$2$4.push(unboxedElem$4);
        i$9 = ((1 + i$9) | 0)
      };
      var temp$arrayOfExpressions = $makeNativeArrayWrapper($d_LBaseExpression.getArrayOf(), elems$2$4);
      var temp$fromIndex = ((1 + firstAppearanceOfOperationIndex) | 0);
      arrayOfExpressions = temp$arrayOfExpressions;
      fromIndex = temp$fromIndex;
      continue _buildTreeForOperationType
    } else {
      return arrayOfExpressions
    }
  }
});
$c_LTreeBuilderAndEvaluator$.prototype.getInnerContent__T__I__T = (function(str, deep) {
  if (($uI(str.length) === 0)) {
    return str
  };
  var firstChar = (65535 & $uI(str.charCodeAt(0)));
  if (((firstChar === 41) && (deep === 1))) {
    return ")"
  };
  var restOfString = $as_T(str.substring(1));
  var updatedDeep = ((firstChar === 40) ? ((1 + deep) | 0) : ((firstChar === 41) ? (((-1) + deep) | 0) : deep));
  return (("" + new $c_jl_Character().init___C(firstChar)) + this.getInnerContent__T__I__T(restOfString, updatedDeep))
});
$c_LTreeBuilderAndEvaluator$.prototype.unwrapBrackets__AT__I__AT = (function(stack, index) {
  _unwrapBrackets: while (true) {
    var expressionAsString = stack.get(index);
    var mostShallowBrackets = this.getMostShallowBrackets__T__I__LBracketsMatch(expressionAsString, 0);
    if ((mostShallowBrackets !== null)) {
      var wholeMatch = mostShallowBrackets.matched$1;
      var x = $as_T(wholeMatch.substring(1));
      var this$4 = new $c_sci_StringOps().init___T(x);
      var matchBody = $as_T($f_sc_IndexedSeqOptimized__dropRight__I__O(this$4, 1));
      var expressionId = stack.u.length;
      var _2$mcI$sp = mostShallowBrackets.index$1;
      var _1$mcI$sp = ((mostShallowBrackets.index$1 + $uI(wholeMatch.length)) | 0);
      var _2$mcI$sp$1 = $uI(expressionAsString.length);
      var updatedExpressionAsString = ((($as_T(expressionAsString.substring(0, _2$mcI$sp)) + "@") + expressionId) + $as_T(expressionAsString.substring(_1$mcI$sp, _2$mcI$sp$1)));
      var xs = stack;
      var until = index;
      var x$1 = ((until > 0) ? until : 0);
      var y = xs.u.length;
      ...
      var currentLength = xs$1.u.length;
      var len = ((1 + currentLength) | 0);
      var result$1 = $newArrayObject($d_T.getArrayOf(), [len]);
      $m_s_Array$().copy__O__I__O__I__I__V(xs$1, 0, result$1, 0, currentLength);
      result$1.set(currentLength, updatedExpressionAsString);
      var xs$2 = stack;
      var n = ((1 + index) | 0);
      ...
      var result$2 = $m_jl_reflect_Array$().newInstance__jl_Class__I__O($objectGetClass(xs$2).getComponentType__jl_Class(), size$1);
      if ((size$1 > 0)) {
        $m_s_Array$().copy__O__I__O__I__I__V(xs$2, lo, result$2, 0, size$1)
      };
      var xs$3 = $asArrayOf_O(result$2, 1);
      var elems$2 = null;
      elems$2 = [];
      var xs$4 = new $c_scm_WrappedArray$ofRef().init___AO(xs$3);
      var i = 0;
      var len$1 = xs$4.length__I();
      while ((i < len$1)) {
        var arg1 = xs$4.apply__I__O(i);
        var unboxedElem = ((arg1 === null) ? null : arg1);
        elems$2.push(unboxedElem);
        i = ((1 + i) | 0)
      };
      var unboxedElem$1 = ((matchBody === null) ? null : matchBody);
      elems$2.push(unboxedElem$1);
      var xs$5 = $makeNativeArrayWrapper($d_T.getArrayOf(), elems$2);
      var elems$2$1 = null;
      elems$2$1 = [];
      var this$45 = new $c_scm_WrappedArray$ofRef().init___AO(xs$5);
      this$45.length__I();
      var x1 = result$1.u.length;
      switch (x1) {
        case (-1): {
          break
        }
      };
      var xs$6 = new $c_scm_WrappedArray$ofRef().init___AO(result$1);
      var i$1 = 0;
      var len$2 = xs$6.length__I();
      while ((i$1 < len$2)) {
        var arg1$1 = xs$6.apply__I__O(i$1);
        var unboxedElem$2 = ((arg1$1 === null) ? null : arg1$1);
      ...
      while ((i$2 < len$3)) {
        var arg1$2 = xs$7.apply__I__O(i$2);
        var unboxedElem$3 = ((arg1$2 === null) ? null : arg1$2);
        elems$2$1.push(unboxedElem$3);
        i$2 = ((1 + i$2) | 0)
      };
      var updatedQueue = $makeNativeArrayWrapper($d_T.getArrayOf(), elems$2$1);
      var selfUpdate = this.unwrapBrackets__AT__I__AT(updatedQueue, index);
      var temp$index = (((-1) + updatedQueue.u.length) | 0);
      stack = selfUpdate;
      index = temp$index;
      continue _unwrapBrackets
    } else {
      return stack
    }
  }
});
$c_LTreeBuilderAndEvaluator$.prototype.parseString__T__ALBaseExpression = (function(expressionAsString) {
  var this$1 = this.constants$1;
  var this$2 = new $c_sci_MapLike$ImmutableDefaultKeySet().init___sci_MapLike(this$1);
  if ($f_sc_SetLike__isEmpty__Z(this$2)) {
    throw new $c_jl_UnsupportedOperationException().init___T("empty.reduceLeft")
  };
  var elem$1 = false;
  elem$1 = true;
  var elem$1$1 = null;
  elem$1$1 = 0;
  var this$5 = this$2.$$outer$4.keysIterator__sc_Iterator();
  while (this$5.hasNext__Z()) {
    ...
    if (elem$1) {
      ...
      var arg1$1 = elem$1$1;
      var x$11 = $as_T(arg1$1);
      var x$12 = $as_T(arg1);
      var this$8 = new $c_sci_StringOps().init___T(x$11);
      var that = new $c_sci_StringOps().init___T(x$12);
      var bf = $m_s_Predef$().StringCanBuildFrom$2;
      elem$1$1 = $as_T($f_sc_TraversableLike__$$plus$plus__sc_GenTraversableOnce__scg_CanBuildFrom__O(this$8, that, bf))
    }
  };
  var constantsJoined = $as_T(elem$1$1);
  var splitRegex = (("@[0-9]+|[0-9\\.]+|[a-z]+|[" + constantsJoined) + "]+");
  var zeroWidthRegex = (((("(?<=" + splitRegex) + ")|(?=") + splitRegex) + ")");
  var xs = $m_sjsr_RuntimeString$().split__T__T__I__AT(expressionAsString, zeroWidthRegex, 0);
  var b = new $c_scm_ArrayBuilder$ofRef().init___s_reflect_ClassTag($m_s_reflect_ClassTag$().apply__jl_Class__s_reflect_ClassTag($objectGetClass(xs).getComponentType__jl_Class()));
  var i = 0;
  var len = xs.u.length;
  while ((i < len)) {
    var index = i;
    var arg1$2 = xs.get(index);
    var x$13 = $as_T(arg1$2);
    if (((x$13 !== null) !== false)) {
      b.$$plus$eq__O__scm_ArrayBuilder$ofRef(arg1$2)
    };
    i = ((1 + i) | 0)
  };
  var tokenizedString = this.combineAtSign__AT__AT($asArrayOf_T(b.result__AO(), 1));
  var elems$2 = null;
  elems$2 = [];
  var len$1 = tokenizedString.u.length;
  var i$1 = 0;
  while ((i$1 < len$1)) {
    var index$1 = i$1;
    var elem = new $c_T2().init___O__O(tokenizedString.get(index$1), i$1);
    elems$2.push(elem);
    i$1 = ((1 + i$1) | 0)
  };
  var xs$1 = $makeNativeArrayWrapper($d_T2.getArrayOf(), elems$2);
  ...
  while ((i$2 < len$2)) {
    ...
    matchEnd5: {
      var elem$2;
      if ((x0$1 !== null)) {
        var s = $as_T(x0$1.$$und1__O());
        if ((s !== null)) {
          if ((s === null)) {
            throw new $c_jl_NullPointerException().init___()
          };
          if ($m_ju_regex_Pattern$().matches__T__jl_CharSequence__Z("@[0-9]+|[0-9\\.]+", s)) {
            if (((65535 & $uI(s.charCodeAt(0))) === 64)) {
              var x = $as_T(s.substring(1));
              var this$34 = new $c_sci_StringOps().init___T(x);
              var jsx$1 = $m_jl_Double$();
              var $$this = this$34.repr$1;
              var x$16 = jsx$1.parseDouble__T__D($$this);
              var x$17 = $m_LOperation$().Identity$2;
              var elem$2 = new $c_LIdentityExpression().init___s_Enumeration$Value__Z__D(x$17, true, x$16);
              break matchEnd5
            } else {
              var this$38 = new $c_sci_StringOps().init___T(s);
              var jsx$2 = $m_jl_Double$();
              var $$this$1 = this$38.repr$1;
              var x$19 = jsx$2.parseDouble__T__D($$this$1);
              var x$20 = $m_LOperation$().Identity$2;
              var elem$2 = new $c_LIdentityExpression().init___s_Enumeration$Value__Z__D(x$20, false, x$19);
              break matchEnd5
            }
          } else if ($m_LTreeBuilderAndEvaluator$().constants$1.get__O__s_Option(s).isDefined__Z()) {
            var x$22 = $uD($m_LTreeBuilderAndEvaluator$().constants$1.apply__O__O(s));
            var x$23 = $m_LOperation$().Identity$2;
            var elem$2 = new $c_LIdentityExpression().init___s_Enumeration$Value__Z__D(x$23, false, x$22);
            break matchEnd5
          } else {
            var this$42 = $m_LTreeBuilderAndEvaluator$().operationsDefinitions$1;
            var this$43 = this$42.reverseList$1__p5__sci_List();
            var this$44 = new $c_sc_LinearSeqLike$$anon$1().init___sc_LinearSeqLike(this$43);
            inlinereturn$155: {
              while (this$44.hasNext__Z()) {
                var a = this$44.next__O();
                var x$14 = $as_T2(a);
                if (($as_LOperationDefinition(x$14.$$und2__O()).stringRepresentation$1 === s)) {
                  var operationDefinition = new $c_s_Some().init___O(a);
                  break inlinereturn$155
                }
              };
              var operationDefinition = $m_s_None$()
            };
            if (operationDefinition.isDefined__Z()) {
              var operation = $as_s_Enumeration$Value($as_T2(operationDefinition.get__O()).$$und1__O());
              var xs$2 = $m_sci_Nil$();
              var len$3 = $f_sc_LinearSeqOptimized__length__I(xs$2);
              var array = $newArrayObject($d_LBaseExpression.getArrayOf(), [len$3]);
              var elem$1$2 = 0;
              elem$1$2 = 0;
              var this$48 = new $c_sc_LinearSeqLike$$anon$1().init___sc_LinearSeqLike(xs$2);
              while (this$48.hasNext__Z()) {
                var arg1$4 = this$48.next__O();
                array.set(elem$1$2, arg1$4);
                elem$1$2 = ((1 + elem$1$2) | 0)
              };
              var elem$2 = new $c_LExpression().init___s_Enumeration$Value__ALBaseExpression(operation, array);
              break matchEnd5
            } else {
              var elem$2 = null;
              break matchEnd5
  ...
  var parsedString = $makeNativeArrayWrapper($d_LBaseExpression.getArrayOf(), elems$2$1);
  return parsedString
});
$c_LTreeBuilderAndEvaluator$.prototype.buildTree__ALBaseExpression__sci_Map__ALBaseExpression = (function(arrayOfExpressions, definitions) {
  _buildTree: while (true) {
    if (definitions.isEmpty__Z()) {
      return arrayOfExpressions
    };
    var current = $as_T2(definitions.head__O());
    var this$1 = definitions;
    var restOfDefinitions = $as_sci_Map($f_sc_IterableLike__drop__I__O(this$1, 1));
    var temp$arrayOfExpressions = this.buildTreeForOperationType__ALBaseExpression__T2__I__ALBaseExpression(arrayOfExpressions, current, 0);
    arrayOfExpressions = temp$arrayOfExpressions;
    definitions = restOfDefinitions;
    continue _buildTree
  }
});
$c_LTreeBuilderAndEvaluator$.prototype.main__AT__V = (function(args) {
  $f_s_App__main__AT__V(this, args)
});
$c_LTreeBuilderAndEvaluator$.prototype.evaluateTree__LBaseExpression__sjs_js_Dictionary = (function(root) {
  if ($is_LIdentityExpression(root)) {
    var x2 = $as_LIdentityExpression(root);
    ...
    inlinereturn$6: {
      while (this$3.hasNext__Z()) {
        ...
        var actualValue = $uD(x0$3.$$und2__O());
        if ((value === actualValue)) {
          var this$4 = new $c_s_Some().init___O(a);
    ...
    if (this$4.isEmpty__Z()) {
      ...
      var representation = $as_T(x0$4.$$und1__O());
      var maybeConstant = new $c_s_Some().init___O(representation)
    };
    var valueAsString = ("" + value);
    var valueToDisplay = $as_T((maybeConstant.isEmpty__Z() ? valueAsString : maybeConstant.get__O()));
    var this$23 = $m_sjs_js_JSConverters$JSRichGenMap$();
    var jsx$2 = new $c_T2().init___O__O("value", valueToDisplay);
    ...
    var y = jsx$1.toJSArray$extension__sc_GenTraversableOnce__sjs_js_Array($m_s_Predef$().genericArrayOps__O__scm_ArrayOps(array));
    var array$1 = [jsx$2, new $c_T2().init___O__O("children", y), new $c_T2().init___O__O("secondaryValue", valueAsString)];
    var this$21 = new $c_scm_MapBuilder().init___sc_GenMap($m_sci_Map$EmptyMap$());
    var i = 0;
    var len$1 = $uI(array$1.length);
    while ((i < len$1)) {
      var index = i;
      var arg1$2 = array$1[index];
      this$21.$$plus$eq__T2__scm_MapBuilder($as_T2(arg1$2));
      i = ((1 + i) | 0)
    };
    var map = this$21.elems$1;
    var result = {};
    map.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, result$1) {
      return (function(x0$1$2) {
        var x0$1 = $as_T2(x0$1$2);
        if ((x0$1 !== null)) {
          var key = $as_T(x0$1.$$und1__O());
          var value$1 = x0$1.$$und2__O();
    ...
    return result
  } else if ($is_LBracketsExpression(root)) {
    var x3 = $as_LBracketsExpression(root);
    var xs$1 = x3.arguments$1;
    var elems$2 = null;
    elems$2 = [];
    var x1 = xs$1.u.length;
    switch (x1) {
    ...
    while ((i$1 < len$2)) {
      var index$1 = i$1;
      var arg1$3 = xs$1.get(index$1);
      var arg = $as_LBaseExpression(arg1$3);
      var elem = $m_LTreeBuilderAndEvaluator$().evaluateTree__LBaseExpression__sjs_js_Dictionary(arg);
      var unboxedElem = ((elem === null) ? null : elem);
      elems$2.push(unboxedElem);
      i$1 = ((1 + i$1) | 0)
    };
    var argsEvaluated = $makeNativeArrayWrapper($d_sjs_js_Dictionary.getArrayOf(), elems$2);
    var this$34 = new $c_scm_ArrayOps$ofRef().init___AO(argsEvaluated);
    var dict = $f_sc_IndexedSeqOptimized__head__O(this$34);
    var secondaryValue = $objectToString(($uZ($m_sjs_js_WrappedDictionary$Cache$().safeHasOwnProperty$1.call(dict, "secondaryValue")) ? new $c_s_Some().init___O(dict.secondaryValue) : $m_s_None$()).get__O());
    var jsx$4 = $m_sjs_js_Dictionary$();
    var jsx$3 = new $c_T2().init___O__O("value", "()");
    var y$1 = $m_sjs_js_JSConverters$JSRichGenTraversableOnce$().toJSArray$extension__sc_GenTraversableOnce__sjs_js_Array($m_s_Predef$().genericArrayOps__O__scm_ArrayOps(argsEvaluated));
    var array$2 = [jsx$3, new $c_T2().init___O__O("children", y$1), new $c_T2().init___O__O("secondaryValue", secondaryValue)];
    return jsx$4.apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$2))
  } else if ($is_LExpression(root)) {
    var x4 = $as_LExpression(root);
    var xs$2 = x4.arguments$1;
    var elems$2$1 = null;
    elems$2$1 = [];
    var x1$1 = xs$2.u.length;
    switch (x1$1) {
      case (-1): {
        break
      }
    ...
    var i$2 = 0;
    var len$3 = xs$2.u.length;
    while ((i$2 < len$3)) {
      var index$2 = i$2;
      var arg1$4 = xs$2.get(index$2);
      var arg$3 = $as_LBaseExpression(arg1$4);
      var elem$2 = $m_LTreeBuilderAndEvaluator$().evaluateTree__LBaseExpression__sjs_js_Dictionary(arg$3);
      var unboxedElem$1 = ((elem$2 === null) ? null : elem$2);
      elems$2$1.push(unboxedElem$1);
      i$2 = ((1 + i$2) | 0)
    };
    var argsEvaluated$2 = $makeNativeArrayWrapper($d_sjs_js_Dictionary.getArrayOf(), elems$2$1);
    var operation = x4.operation$1;
    var valueToDisplay$2 = $as_LOperationDefinition(this.operationsDefinitions$1.apply__O__O(operation)).stringRepresentation$1;
    var elems$2$2 = null;
    elems$2$2 = [];
    var x1$2 = argsEvaluated$2.u.length;
    switch (x1$2) {
      case (-1): {
        break
      }
    ...
    var i$3 = 0;
    var len$4 = argsEvaluated$2.u.length;
    while ((i$3 < len$4)) {
      var index$3 = i$3;
      var arg1$5 = argsEvaluated$2.get(index$3);
      var x = $objectToString(($uZ($m_sjs_js_WrappedDictionary$Cache$().safeHasOwnProperty$1.call(arg1$5, "secondaryValue")) ? new $c_s_Some().init___O(arg1$5.secondaryValue) : $m_s_None$()).get__O());
      var this$66 = new $c_sci_StringOps().init___T(x);
      var jsx$5 = $m_jl_Double$();
      var $$this = this$66.repr$1;
      var elem$3 = jsx$5.parseDouble__T__D($$this);
      elems$2$2.push(elem$3);
      i$3 = ((1 + i$3) | 0)
    };
    var argsValue = $makeNativeArrayWrapper($d_D.getArrayOf(), elems$2$2);
    var secondaryValue$2 = $uD($as_LOperationDefinition(this.operationsDefinitions$1.apply__O__O(x4.operation$1)).evaluator$1.apply__O__O(argsValue));
    var jsx$8 = $m_sjs_js_Dictionary$();
    var jsx$7 = new $c_T2().init___O__O("value", valueToDisplay$2);
    var y$2 = $m_sjs_js_JSConverters$JSRichGenTraversableOnce$().toJSArray$extension__sc_GenTraversableOnce__sjs_js_Array($m_s_Predef$().genericArrayOps__O__scm_ArrayOps(argsEvaluated$2));
    var jsx$6 = new $c_T2().init___O__O("children", y$2);
    var y$3 = ("" + secondaryValue$2);
    var array$3 = [jsx$7, jsx$6, new $c_T2().init___O__O("secondaryValue", y$3)];
    return jsx$8.apply__sc_Seq__sjs_js_Dictionary(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$3))
  } else {
    throw new $c_s_MatchError().init___O(root)
  }
});
$c_LTreeBuilderAndEvaluator$.prototype.$$js$exported$meth$evaluateTree__LBaseExpression__O = (function(root) {
  return this.evaluateTree__LBaseExpression__sjs_js_Dictionary(root)
});
$c_LTreeBuilderAndEvaluator$.prototype.combineAtSign__AT__AT = (function(splitedString) {
  _combineAtSign: while (true) {
    if ((splitedString.u.length <= 1)) {
      return splitedString
    } else {
      var xs = splitedString;
      var this$2 = new $c_scm_ArrayOps$ofRef().init___AO(xs);
      var currentChar = $as_T($f_sc_IndexedSeqOptimized__last__O(this$2));
      var nextChar = splitedString.get((((-2) + splitedString.u.length) | 0));
      if ((nextChar === "@")) {
        var xs$1 = splitedString;
        var until = (((-2) + xs$1.u.length) | 0);
        ...
        if ((size > 0)) {
          $m_s_Array$().copy__O__I__O__I__I__V(xs$1, 0, result, 0, size)
        };
        var xs$2 = this.combineAtSign__AT__AT($asArrayOf_T(result, 1));
        var this$18 = new $c_sci_StringOps().init___T(nextChar);
        var that = new $c_sci_StringOps().init___T(currentChar);
        var bf = $m_s_Predef$().StringCanBuildFrom$2;
        var elem = $f_sc_TraversableLike__$$plus$plus__sc_GenTraversableOnce__scg_CanBuildFrom__O(this$18, that, bf);
        var currentLength = xs$2.u.length;
        var len = ((1 + currentLength) | 0);
        var result$1 = $newArrayObject($d_T.getArrayOf(), [len]);
        $m_s_Array$().copy__O__I__O__I__I__V(xs$2, 0, result$1, 0, currentLength);
        result$1.set(currentLength, elem);
        return result$1
      } else {
        if (this.constants$1.get__O__s_Option(currentChar).isDefined__Z()) {
          if ((nextChar === null)) {
            throw new $c_jl_NullPointerException().init___()
          };
          var jsx$1 = $m_ju_regex_Pattern$().matches__T__jl_CharSequence__Z("[0-9\\.]+", nextChar)
        } else {
          var jsx$1 = false
        };
        if (jsx$1) {
          var xs$3 = splitedString;
          var until$1 = (((-1) + xs$3.u.length) | 0);
          var x$1 = ((until$1 > 0) ? until$1 : 0);
          var y$1 = xs$3.u.length;
          var hi$1 = ((x$1 < y$1) ? x$1 : y$1);
          var size$1 = ((hi$1 > 0) ? hi$1 : 0);
          var result$2 = $m_jl_reflect_Array$().newInstance__jl_Class__I__O($objectGetClass(xs$3).getComponentType__jl_Class(), size$1);
          if ((size$1 > 0)) {
            $m_s_Array$().copy__O__I__O__I__I__V(xs$3, 0, result$2, 0, size$1)
          };
          var xs$4 = $asArrayOf_O(result$2, 1);
          var elem$1 = $as_LOperationDefinition(this.operationsDefinitions$1.apply__O__O($m_LOperation$().Mul$2)).stringRepresentation$1;
          var currentLength$1 = xs$4.u.length;
          var len$1 = ((1 + currentLength$1) | 0);
          var result$3 = $newArrayObject($d_T.getArrayOf(), [len$1]);
          $m_s_Array$().copy__O__I__O__I__I__V(xs$4, 0, result$3, 0, currentLength$1);
          result$3.set(currentLength$1, elem$1);
          var currentLength$2 = result$3.u.length;
          var len$2 = ((1 + currentLength$2) | 0);
          var result$4 = $newArrayObject($d_T.getArrayOf(), [len$2]);
          $m_s_Array$().copy__O__I__O__I__I__V(result$3, 0, result$4, 0, currentLength$2);
          result$4.set(currentLength$2, currentChar);
          splitedString = result$4;
          continue _combineAtSign
        } else {
          if ((currentChar === null)) {
            throw new $c_jl_NullPointerException().init___()
          };
          if ($m_ju_regex_Pattern$().matches__T__jl_CharSequence__Z("[0-9\\.]+", currentChar)) {
            var xs$5 = splitedString;
            var b = new $c_scm_ArrayBuilder$ofRef().init___s_reflect_ClassTag($m_s_reflect_ClassTag$().apply__jl_Class__s_reflect_ClassTag($objectGetClass(xs$5).getComponentType__jl_Class()));
            b.sizeHint__I__V(xs$5.u.length);
            var i = xs$5.u.length;
            while ((i > 0)) {
              i = (((-1) + i) | 0);
              var index = i;
              var elem$2 = xs$5.get(index);
              b.$$plus$eq__O__scm_ArrayBuilder$ofRef(elem$2)
            };
            var xs$6 = b.result__AO();
            var len$3 = xs$6.u.length;
            var i$1 = 0;
            while (true) {
              if ((i$1 < len$3)) {
                var index$1 = i$1;
                var arg1 = xs$6.get(index$1);
                var x$5 = $as_T(arg1);
                if ((x$5 === null)) {
                  throw new $c_jl_NullPointerException().init___()
                };
                var jsx$2 = $m_ju_regex_Pattern$().matches__T__jl_CharSequence__Z("[0-9\\.]+", x$5)
              } else {
                var jsx$2 = false
              };
              if (jsx$2) {
            ...
            var n = i$1;
            var x$2 = ((n > 0) ? n : 0);
            var y$2 = xs$6.u.length;
            var hi$2 = ((x$2 < y$2) ? x$2 : y$2);
            var size$2 = ((hi$2 > 0) ? hi$2 : 0);
            var result$5 = $m_jl_reflect_Array$().newInstance__jl_Class__I__O($objectGetClass(xs$6).getComponentType__jl_Class(), size$2);
            if ((size$2 > 0)) {
              $m_s_Array$().copy__O__I__O__I__I__V(xs$6, 0, result$5, 0, size$2)
            };
            var xs$7 = $asArrayOf_O(result$5, 1);
            var b$1 = new $c_scm_ArrayBuilder$ofRef().init___s_reflect_ClassTag($m_s_reflect_ClassTag$().apply__jl_Class__s_reflect_ClassTag($objectGetClass(xs$7).getComponentType__jl_Class()));
            b$1.sizeHint__I__V(xs$7.u.length);
            var i$2 = xs$7.u.length;
            while ((i$2 > 0)) {
              i$2 = (((-1) + i$2) | 0);
              var index$2 = i$2;
              var elem$3 = xs$7.get(index$2);
              b$1.$$plus$eq__O__scm_ArrayBuilder$ofRef(elem$3)
            };
            var digitsCountFromEnd = $asArrayOf_T(b$1.result__AO(), 1);
            var f = (function(this$2$1) {
              return (function(x$6$2, x$7$2) {
                var x$6 = $as_T(x$6$2);
                var x$7 = $as_T(x$7$2);
                var this$63 = new $c_sci_StringOps().init___T(x$6);
                var that$1 = new $c_sci_StringOps().init___T(x$7);
                var bf$1 = $m_s_Predef$().StringCanBuildFrom$2;
                return $as_T($f_sc_TraversableLike__$$plus$plus__sc_GenTraversableOnce__scg_CanBuildFrom__O(this$63, that$1, bf$1))
              })
            })(this);
            if ((digitsCountFromEnd.u.length > 0)) {
              var start = 1;
              var end = digitsCountFromEnd.u.length;
              var z = digitsCountFromEnd.get(0);
              var start$1 = start;
              var z$1 = z;
              var jsx$3;
              _foldl: while (true) {
                if ((start$1 !== end)) {
                  ...
                  var arg1$1 = z$1;
                  var index$3 = start$1;
                  var arg2 = digitsCountFromEnd.get(index$3);
              ...
              elem$1$2 = 0;
              var i$3 = 0;
              var len$4 = digitsCountFromEnd.u.length;
              while ((i$3 < len$4)) {
                var index$4 = i$3;
                var arg1$2 = digitsCountFromEnd.get(index$4);
                if (elem$1$1) {
                  elem$1$2 = arg1$2;
                  elem$1$1 = false
                } else {
                  var arg1$3 = elem$1$2;
                  elem$1$2 = f(arg1$3, arg1$2)
                };
                i$3 = ((1 + i$3) | 0)
              };
              var jsx$3 = elem$1$2
            };
            var reducedValue = $as_T(jsx$3);
            var xs$8 = splitedString;
            var n$1 = digitsCountFromEnd.u.length;
            var until$2 = ((xs$8.u.length - ((n$1 > 0) ? n$1 : 0)) | 0);
            var x$3 = ((until$2 > 0) ? until$2 : 0);
            var y$3 = xs$8.u.length;
            var hi$3 = ((x$3 < y$3) ? x$3 : y$3);
            var size$3 = ((hi$3 > 0) ? hi$3 : 0);
            var result$6 = $m_jl_reflect_Array$().newInstance__jl_Class__I__O($objectGetClass(xs$8).getComponentType__jl_Class(), size$3);
            if ((size$3 > 0)) {
              $m_s_Array$().copy__O__I__O__I__I__V(xs$8, 0, result$6, 0, size$3)
            };
            var xs$9 = this.combineAtSign__AT__AT($asArrayOf_T(result$6, 1));
            var currentLength$3 = xs$9.u.length;
            var len$5 = ((1 + currentLength$3) | 0);
            var result$7 = $newArrayObject($d_T.getArrayOf(), [len$5]);
            $m_s_Array$().copy__O__I__O__I__I__V(xs$9, 0, result$7, 0, currentLength$3);
            result$7.set(currentLength$3, reducedValue);
            return result$7
          } else {
            if ((currentChar === null)) {
              throw new $c_jl_NullPointerException().init___()
            };
            if ($m_ju_regex_Pattern$().matches__T__jl_CharSequence__Z("[a-z]+", currentChar)) {
              var xs$10 = splitedString;
              var b$2 = new $c_scm_ArrayBuilder$ofRef().init___s_reflect_ClassTag($m_s_reflect_ClassTag$().apply__jl_Class__s_reflect_ClassTag($objectGetClass(xs$10).getComponentType__jl_Class()));
              b$2.sizeHint__I__V(xs$10.u.length);
              var i$4 = xs$10.u.length;
              while ((i$4 > 0)) {
                i$4 = (((-1) + i$4) | 0);
                var index$5 = i$4;
                var elem$4 = xs$10.get(index$5);
                b$2.$$plus$eq__O__scm_ArrayBuilder$ofRef(elem$4)
              };
              var xs$11 = b$2.result__AO();
              var len$6 = xs$11.u.length;
              var i$5 = 0;
              while (true) {
                if ((i$5 < len$6)) {
                  var index$6 = i$5;
                  var arg1$4 = xs$11.get(index$6);
                  var x$8 = $as_T(arg1$4);
                  if ((x$8 === null)) {
                    throw new $c_jl_NullPointerException().init___()
                  };
                  var jsx$4 = $m_ju_regex_Pattern$().matches__T__jl_CharSequence__Z("[a-z]+", x$8)
                } else {
                  var jsx$4 = false
                };
                if (jsx$4) {
              ...
              var n$2 = i$5;
              var x$4 = ((n$2 > 0) ? n$2 : 0);
              var y$4 = xs$11.u.length;
              var hi$4 = ((x$4 < y$4) ? x$4 : y$4);
              var size$4 = ((hi$4 > 0) ? hi$4 : 0);
              var result$8 = $m_jl_reflect_Array$().newInstance__jl_Class__I__O($objectGetClass(xs$11).getComponentType__jl_Class(), size$4);
              if ((size$4 > 0)) {
                $m_s_Array$().copy__O__I__O__I__I__V(xs$11, 0, result$8, 0, size$4)
              };
              var xs$12 = $asArrayOf_O(result$8, 1);
              var b$3 = new $c_scm_ArrayBuilder$ofRef().init___s_reflect_ClassTag($m_s_reflect_ClassTag$().apply__jl_Class__s_reflect_ClassTag($objectGetClass(xs$12).getComponentType__jl_Class()));
              b$3.sizeHint__I__V(xs$12.u.length);
              var i$6 = xs$12.u.length;
              while ((i$6 > 0)) {
                i$6 = (((-1) + i$6) | 0);
                var index$7 = i$6;
                var elem$5 = xs$12.get(index$7);
                b$3.$$plus$eq__O__scm_ArrayBuilder$ofRef(elem$5)
              };
              var lettersFromEnd = $asArrayOf_T(b$3.result__AO(), 1);
              var f$1 = (function(this$4$1) {
                return (function(x$9$2, x$10$2) {
                  var x$9 = $as_T(x$9$2);
                  var x$10 = $as_T(x$10$2);
                  var this$113 = new $c_sci_StringOps().init___T(x$9);
                  var that$2 = new $c_sci_StringOps().init___T(x$10);
                  var bf$2 = $m_s_Predef$().StringCanBuildFrom$2;
                  return $as_T($f_sc_TraversableLike__$$plus$plus__sc_GenTraversableOnce__scg_CanBuildFrom__O(this$113, that$2, bf$2))
                })
              })(this);
              if ((lettersFromEnd.u.length > 0)) {
                var start$2 = 1;
                var end$1 = lettersFromEnd.u.length;
                var z$2 = lettersFromEnd.get(0);
                var start$3 = start$2;
                var z$3 = z$2;
                var jsx$5;
                _foldl$1: while (true) {
                  if ((start$3 !== end$1)) {
                    ...
                    var arg1$5 = z$3;
                    var index$8 = start$3;
                    var arg2$1 = lettersFromEnd.get(index$8);
                ...
                elem$1$4 = 0;
                var i$7 = 0;
                var len$7 = lettersFromEnd.u.length;
                while ((i$7 < len$7)) {
                  var index$9 = i$7;
                  var arg1$6 = lettersFromEnd.get(index$9);
                  if (elem$1$3) {
                    elem$1$4 = arg1$6;
                    elem$1$3 = false
                  } else {
                    var arg1$7 = elem$1$4;
                    elem$1$4 = f$1(arg1$7, arg1$6)
                  };
                  i$7 = ((1 + i$7) | 0)
                };
                var jsx$5 = elem$1$4
              };
              var reducedValue$2 = $as_T(jsx$5);
              var xs$13 = splitedString;
              var n$3 = lettersFromEnd.u.length;
              var until$3 = ((xs$13.u.length - ((n$3 > 0) ? n$3 : 0)) | 0);
              var x$11 = ((until$3 > 0) ? until$3 : 0);
              var y$5 = xs$13.u.length;
              var hi$5 = ((x$11 < y$5) ? x$11 : y$5);
              var size$5 = ((hi$5 > 0) ? hi$5 : 0);
              var result$9 = $m_jl_reflect_Array$().newInstance__jl_Class__I__O($objectGetClass(xs$13).getComponentType__jl_Class(), size$5);
              if ((size$5 > 0)) {
                $m_s_Array$().copy__O__I__O__I__I__V(xs$13, 0, result$9, 0, size$5)
              };
              var xs$14 = this.combineAtSign__AT__AT($asArrayOf_T(result$9, 1));
              var currentLength$4 = xs$14.u.length;
              var len$8 = ((1 + currentLength$4) | 0);
              var result$10 = $newArrayObject($d_T.getArrayOf(), [len$8]);
              $m_s_Array$().copy__O__I__O__I__I__V(xs$14, 0, result$10, 0, currentLength$4);
              result$10.set(currentLength$4, reducedValue$2);
              return result$10
            } else {
              var xs$15 = splitedString;
              var until$4 = (((-1) + xs$15.u.length) | 0);
              var x$12 = ((until$4 > 0) ? until$4 : 0);
              var y$6 = xs$15.u.length;
              var hi$6 = ((x$12 < y$6) ? x$12 : y$6);
              var size$6 = ((hi$6 > 0) ? hi$6 : 0);
              var result$11 = $m_jl_reflect_Array$().newInstance__jl_Class__I__O($objectGetClass(xs$15).getComponentType__jl_Class(), size$6);
              if ((size$6 > 0)) {
                $m_s_Array$().copy__O__I__O__I__I__V(xs$15, 0, result$11, 0, size$6)
              };
              var xs$16 = this.combineAtSign__AT__AT($asArrayOf_T(result$11, 1));
              var currentLength$5 = xs$16.u.length;
              var len$9 = ((1 + currentLength$5) | 0);
              var result$12 = $newArrayObject($d_T.getArrayOf(), [len$9]);
              $m_s_Array$().copy__O__I__O__I__I__V(xs$16, 0, result$12, 0, currentLength$5);
              result$12.set(currentLength$5, currentChar);
              return result$12
            }
          }
        }
...
$c_LTreeBuilderAndEvaluator$.prototype.$$js$exported$meth$buildTreeFromString__T__O = (function(query) {
  return this.buildTreeFromString__T__LBaseExpression(query)
});
$c_LTreeBuilderAndEvaluator$.prototype.getMostShallowBrackets__T__I__LBracketsMatch = (function(str, index) {
  if (($uI(str.length) === 0)) {
    return null
  };
  var firstChar = (65535 & $uI(str.charCodeAt(0)));
  if ((firstChar === 40)) {
    return new $c_LBracketsMatch().init___T__I(this.getInnerContent__T__I__T(str, 0), index)
  };
  var restOfString = $as_T(str.substring(1));
  var recursionStep = this.getMostShallowBrackets__T__I__LBracketsMatch(restOfString, ((1 + index) | 0));
  return recursionStep
});
$c_LTreeBuilderAndEvaluator$.prototype.evaluateTree = (function(arg$1) {
  var prep0 = $as_LBaseExpression(arg$1);
  return this.$$js$exported$meth$evaluateTree__LBaseExpression__O(prep0)
});
$c_LTreeBuilderAndEvaluator$.prototype.buildTreeFromString = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  return this.$$js$exported$meth$buildTreeFromString__T__O(prep0)
});
var $d_LTreeBuilderAndEvaluator$ = new $TypeData().initClass({
  LTreeBuilderAndEvaluator$: 0
}, false, "TreeBuilderAndEvaluator$", {
  LTreeBuilderAndEvaluator$: 1,
  O: 1,
  s_App: 1,
  s_DelayedInit: 1
});
$c_LTreeBuilderAndEvaluator$.prototype.$classData = $d_LTreeBuilderAndEvaluator$;
var $n_LTreeBuilderAndEvaluator$ = (void 0);
function $m_LTreeBuilderAndEvaluator$() {
  if ((!$n_LTreeBuilderAndEvaluator$)) {
    $n_LTreeBuilderAndEvaluator$ = new $c_LTreeBuilderAndEvaluator$().init___()
  };
  return $n_LTreeBuilderAndEvaluator$
}
/** @constructor */
function $c_LTreeBuilderAndEvaluator$delayedInit$body() {
  $c_sr_AbstractFunction0.call(this);
  this.$$outer$2 = null
}
$c_LTreeBuilderAndEvaluator$delayedInit$body.prototype = new $h_sr_AbstractFunction0();
$c_LTreeBuilderAndEvaluator$delayedInit$body.prototype.constructor = $c_LTreeBuilderAndEvaluator$delayedInit$body;
/** @constructor */
function $h_LTreeBuilderAndEvaluator$delayedInit$body() {
  /*<skip>*/
}
$h_LTreeBuilderAndEvaluator$delayedInit$body.prototype = $c_LTreeBuilderAndEvaluator$delayedInit$body.prototype;
$c_LTreeBuilderAndEvaluator$delayedInit$body.prototype.init___LTreeBuilderAndEvaluator$ = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_LTreeBuilderAndEvaluator$delayedInit$body.prototype.apply__O = (function() {
  this.$$outer$2.delayedEndpoint$TreeBuilderAndEvaluator$1__V()
});
var $d_LTreeBuilderAndEvaluator$delayedInit$body = new $TypeData().initClass({
  LTreeBuilderAndEvaluator$delayedInit$body: 0
}, false, "TreeBuilderAndEvaluator$delayedInit$body", {
  LTreeBuilderAndEvaluator$delayedInit$body: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1
});
$c_LTreeBuilderAndEvaluator$delayedInit$body.prototype.$classData = $d_LTreeBuilderAndEvaluator$delayedInit$body;
...
/** @constructor */
function $c_LOperation$() {
  $c_s_Enumeration.call(this);
  this.Identity$2 = null;
  this.Add$2 = null;
  this.Sub$2 = null;
  this.Mul$2 = null;
  this.Div$2 = null;
  ...
  this.Tan$2 = null;
  this.Ln$2 = null;
  this.Factorial$2 = null;
  this.None$2 = null
}
$c_LOperation$.prototype = new $h_s_Enumeration();
$c_LOperation$.prototype.constructor = $c_LOperation$;
/** @constructor */
function $h_LOperation$() {
  /*<skip>*/
}
$h_LOperation$.prototype = $c_LOperation$.prototype;
$c_LOperation$.prototype.init___ = (function() {
  $c_s_Enumeration.prototype.init___I.call(this, 0);
  $n_LOperation$ = this;
  var name = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Identity");
  var i = this.nextId$1;
  this.Identity$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i, name);
  var name$1 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Add");
  var i$1 = this.nextId$1;
  this.Add$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$1, name$1);
  var name$2 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Sub");
  var i$2 = this.nextId$1;
  this.Sub$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$2, name$2);
  var name$3 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Mul");
  var i$3 = this.nextId$1;
  this.Mul$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$3, name$3);
  var name$4 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Div");
  var i$4 = this.nextId$1;
  this.Div$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$4, name$4);
  var name$5 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Sqrt");
  var i$5 = this.nextId$1;
  this.Sqrt$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$5, name$5);
  var name$6 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Pow");
  var i$6 = this.nextId$1;
  this.Pow$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$6, name$6);
  var name$7 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Cos");
  var i$7 = this.nextId$1;
  this.Cos$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$7, name$7);
  var name$8 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Sin");
  var i$8 = this.nextId$1;
  this.Sin$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$8, name$8);
  var name$9 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Tan");
  var i$9 = this.nextId$1;
  this.Tan$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$9, name$9);
  var name$10 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Ln");
  var i$10 = this.nextId$1;
  this.Ln$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$10, name$10);
  var name$11 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "Factorial");
  var i$11 = this.nextId$1;
  this.Factorial$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$11, name$11);
  var name$12 = (((this.nextName$1 !== null) && this.nextName$1.hasNext__Z()) ? $as_T(this.nextName$1.next__O()) : "None");
  var i$12 = this.nextId$1;
  this.None$2 = new $c_s_Enumeration$Val().init___s_Enumeration__I__T(this, i$12, name$12);
  return this
});
var $d_LOperation$ = new $TypeData().initClass({
  LOperation$: 0
}, false, "Operation$", {
  LOperation$: 1,
  s_Enumeration: 1,
...
$c_LOperation$.prototype.$classData = $d_LOperation$;
var $n_LOperation$ = (void 0);
function $m_LOperation$() {
  if ((!$n_LOperation$)) {
    $n_LOperation$ = new $c_LOperation$().init___()
  };
  return $n_LOperation$
}
/** @constructor */
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_LBracketsMatch() {
  $c_O.call(this);
  this.matched$1 = null;
  this.index$1 = 0
}
$c_LBracketsMatch.prototype = new $h_O();
$c_LBracketsMatch.prototype.constructor = $c_LBracketsMatch;
/** @constructor */
function $h_LBracketsMatch() {
  /*<skip>*/
}
$h_LBracketsMatch.prototype = $c_LBracketsMatch.prototype;
$c_LBracketsMatch.prototype.productPrefix__T = (function() {
  return "BracketsMatch"
});
$c_LBracketsMatch.prototype.productArity__I = (function() {
  return 2
});
$c_LBracketsMatch.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_LBracketsMatch(x$1)) {
    var BracketsMatch$1 = $as_LBracketsMatch(x$1);
    return ((this.matched$1 === BracketsMatch$1.matched$1) && (this.index$1 === BracketsMatch$1.index$1))
  } else {
    return false
  }
});
$c_LBracketsMatch.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
...
$c_LBracketsMatch.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_LBracketsMatch.prototype.init___T__I = (function(matched, index) {
  this.matched$1 = matched;
  this.index$1 = index;
  return this
});
$c_LBracketsMatch.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.matched$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.index$1);
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 2)
});
$c_LBracketsMatch.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_LBracketsMatch(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LBracketsMatch)))
}
function $as_LBracketsMatch(obj) {
  return (($is_LBracketsMatch(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "BracketsMatch"))
}
function $isArrayOf_LBracketsMatch(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LBracketsMatch)))
}
function $asArrayOf_LBracketsMatch(obj, depth) {
  return (($isArrayOf_LBracketsMatch(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LBracketsMatch;", depth))
}
var $d_LBracketsMatch = new $TypeData().initClass({
  LBracketsMatch: 0
}, false, "BracketsMatch", {
  LBracketsMatch: 1,
  O: 1,
...
$c_LBracketsMatch.prototype.$classData = $d_LBracketsMatch;
/** @constructor */
function $c_LOperationDefinition() {
  $c_O.call(this);
  this.stringRepresentation$1 = null;
  this.argumentsOffsets$1 = null;
  this.evaluator$1 = null
}
$c_LOperationDefinition.prototype = new $h_O();
$c_LOperationDefinition.prototype.constructor = $c_LOperationDefinition;
/** @constructor */
function $h_LOperationDefinition() {
  /*<skip>*/
}
$h_LOperationDefinition.prototype = $c_LOperationDefinition.prototype;
$c_LOperationDefinition.prototype.productPrefix__T = (function() {
  return "OperationDefinition"
});
$c_LOperationDefinition.prototype.productArity__I = (function() {
  return 3
});
$c_LOperationDefinition.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_LOperationDefinition(x$1)) {
    var OperationDefinition$1 = $as_LOperationDefinition(x$1);
    if (((this.stringRepresentation$1 === OperationDefinition$1.stringRepresentation$1) && (this.argumentsOffsets$1 === OperationDefinition$1.argumentsOffsets$1))) {
      var x = this.evaluator$1;
      var x$2 = OperationDefinition$1.evaluator$1;
...
$c_LOperationDefinition.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.stringRepresentation$1;
      break
    }
    case 1: {
      return this.argumentsOffsets$1;
      break
    }
    case 2: {
      return this.evaluator$1;
      break
    }
    default: {
      throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
...
$c_LOperationDefinition.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_LOperationDefinition.prototype.init___T__AI__F1 = (function(stringRepresentation, argumentsOffsets, evaluator) {
  this.stringRepresentation$1 = stringRepresentation;
  this.argumentsOffsets$1 = argumentsOffsets;
  this.evaluator$1 = evaluator;
  return this
});
$c_LOperationDefinition.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_LOperationDefinition.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_LOperationDefinition(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LOperationDefinition)))
}
function $as_LOperationDefinition(obj) {
  return (($is_LOperationDefinition(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "OperationDefinition"))
}
function $isArrayOf_LOperationDefinition(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LOperationDefinition)))
}
function $asArrayOf_LOperationDefinition(obj, depth) {
  return (($isArrayOf_LOperationDefinition(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LOperationDefinition;", depth))
}
var $d_LOperationDefinition = new $TypeData().initClass({
  LOperationDefinition: 0
}, false, "OperationDefinition", {
  LOperationDefinition: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_LOperationDefinition.prototype.$classData = $d_LOperationDefinition;
/** @constructor */
...
/** @constructor */
function $c_LIdentityExpression() {
  $c_O.call(this);
  this.operation$1 = null;
  this.isReference$1 = false;
  this.value$1 = 0.0
}
$c_LIdentityExpression.prototype = new $h_O();
$c_LIdentityExpression.prototype.constructor = $c_LIdentityExpression;
/** @constructor */
function $h_LIdentityExpression() {
  /*<skip>*/
}
$h_LIdentityExpression.prototype = $c_LIdentityExpression.prototype;
$c_LIdentityExpression.prototype.productPrefix__T = (function() {
  return "IdentityExpression"
});
$c_LIdentityExpression.prototype.productArity__I = (function() {
  return 3
});
$c_LIdentityExpression.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_LIdentityExpression(x$1)) {
    var IdentityExpression$1 = $as_LIdentityExpression(x$1);
    var x = this.operation$1;
    var x$2 = IdentityExpression$1.operation$1;
    if ((((x === null) ? (x$2 === null) : x.equals__O__Z(x$2)) && (this.isReference$1 === IdentityExpression$1.isReference$1))) {
      return (this.value$1 === IdentityExpression$1.value$1)
    } else {
      return false
    }
  } else {
...
$c_LIdentityExpression.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
...
$c_LIdentityExpression.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_LIdentityExpression.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().anyHash__O__I(this.operation$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, (this.isReference$1 ? 1231 : 1237));
...
$c_LIdentityExpression.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_LIdentityExpression.prototype.init___s_Enumeration$Value__Z__D = (function(operation, isReference, value) {
  this.operation$1 = operation;
  this.isReference$1 = isReference;
  this.value$1 = value;
  return this
});
$c_LIdentityExpression.prototype.operation__s_Enumeration$Value = (function() {
  return this.operation$1
});
function $is_LIdentityExpression(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LIdentityExpression)))
}
function $as_LIdentityExpression(obj) {
  return (($is_LIdentityExpression(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "IdentityExpression"))
}
function $isArrayOf_LIdentityExpression(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LIdentityExpression)))
}
function $asArrayOf_LIdentityExpression(obj, depth) {
  return (($isArrayOf_LIdentityExpression(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LIdentityExpression;", depth))
}
var $d_LIdentityExpression = new $TypeData().initClass({
  LIdentityExpression: 0
}, false, "IdentityExpression", {
  LIdentityExpression: 1,
  O: 1,
  LBaseExpression: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_LIdentityExpression.prototype.$classData = $d_LIdentityExpression;
/** @constructor */
function $c_T2() {
  $c_O.call(this);
  this.$$und1$f = null;
...
/** @constructor */
function $c_LBracketsExpression() {
  $c_O.call(this);
  this.operation$1 = null;
  this.arguments$1 = null
}
$c_LBracketsExpression.prototype = new $h_O();
$c_LBracketsExpression.prototype.constructor = $c_LBracketsExpression;
/** @constructor */
function $h_LBracketsExpression() {
  /*<skip>*/
}
$h_LBracketsExpression.prototype = $c_LBracketsExpression.prototype;
$c_LBracketsExpression.prototype.productPrefix__T = (function() {
  return "BracketsExpression"
});
$c_LBracketsExpression.prototype.productArity__I = (function() {
  return 2
});
$c_LBracketsExpression.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_LBracketsExpression(x$1)) {
    var BracketsExpression$1 = $as_LBracketsExpression(x$1);
    var x = this.operation$1;
    var x$2 = BracketsExpression$1.operation$1;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      return (this.arguments$1 === BracketsExpression$1.arguments$1)
    } else {
      return false
    }
  } else {
...
$c_LBracketsExpression.prototype.arguments__ALBaseExpression = (function() {
  return this.arguments$1
});
$c_LBracketsExpression.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.operation$1;
      break
...
$c_LBracketsExpression.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_LBracketsExpression.prototype.copy__ALBaseExpression__LExpressionWithChildren = (function(arguments$2) {
  return new $c_LBracketsExpression().init___s_Enumeration$Value__ALBaseExpression(this.operation$1, arguments$2)
});
$c_LBracketsExpression.prototype.init___s_Enumeration$Value__ALBaseExpression = (function(operation, arguments$2) {
  this.operation$1 = operation;
  this.arguments$1 = arguments$2;
  return this
});
$c_LBracketsExpression.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_LBracketsExpression.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_LBracketsExpression.prototype.operation__s_Enumeration$Value = (function() {
  return this.operation$1
});
function $is_LBracketsExpression(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LBracketsExpression)))
}
function $as_LBracketsExpression(obj) {
  return (($is_LBracketsExpression(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "BracketsExpression"))
}
function $isArrayOf_LBracketsExpression(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LBracketsExpression)))
}
function $asArrayOf_LBracketsExpression(obj, depth) {
  return (($isArrayOf_LBracketsExpression(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LBracketsExpression;", depth))
}
var $d_LBracketsExpression = new $TypeData().initClass({
  LBracketsExpression: 0
}, false, "BracketsExpression", {
  LBracketsExpression: 1,
  O: 1,
  LBaseExpression: 1,
  LExpressionWithChildren: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1
});
$c_LBracketsExpression.prototype.$classData = $d_LBracketsExpression;
/** @constructor */
function $c_LExpression() {
  $c_O.call(this);
  this.operation$1 = null;
  this.arguments$1 = null
}
$c_LExpression.prototype = new $h_O();
$c_LExpression.prototype.constructor = $c_LExpression;
/** @constructor */
function $h_LExpression() {
  /*<skip>*/
}
$h_LExpression.prototype = $c_LExpression.prototype;
$c_LExpression.prototype.productPrefix__T = (function() {
  return "Expression"
});
$c_LExpression.prototype.productArity__I = (function() {
  return 2
});
$c_LExpression.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_LExpression(x$1)) {
    var Expression$1 = $as_LExpression(x$1);
    var x = this.operation$1;
    var x$2 = Expression$1.operation$1;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      return (this.arguments$1 === Expression$1.arguments$1)
    } else {
      return false
    }
  } else {
...
$c_LExpression.prototype.arguments__ALBaseExpression = (function() {
  return this.arguments$1
});
$c_LExpression.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.operation$1;
      break
...
$c_LExpression.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_LExpression.prototype.copy__ALBaseExpression__LExpressionWithChildren = (function(arguments$2) {
  return new $c_LExpression().init___s_Enumeration$Value__ALBaseExpression(this.operation$1, arguments$2)
});
$c_LExpression.prototype.init___s_Enumeration$Value__ALBaseExpression = (function(operation, arguments$2) {
  this.operation$1 = operation;
  this.arguments$1 = arguments$2;
  return this
});
$c_LExpression.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_LExpression.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_LExpression.prototype.operation__s_Enumeration$Value = (function() {
  return this.operation$1
});
function $is_LExpression(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LExpression)))
}
function $as_LExpression(obj) {
  return (($is_LExpression(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "Expression"))
}
function $isArrayOf_LExpression(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LExpression)))
}
function $asArrayOf_LExpression(obj, depth) {
  return (($isArrayOf_LExpression(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LExpression;", depth))
}
var $d_LExpression = new $TypeData().initClass({
  LExpression: 0
}, false, "Expression", {
  LExpression: 1,
  O: 1,
...
$c_LExpression.prototype.$classData = $d_LExpression;
/** @constructor */
...
function $f_scm_ArrayOps__slice__I__I__O($thiz, from, until) {
  var reprVal = $thiz.repr__O();
  var lo = ((from > 0) ? from : 0);
  var x = ((until > 0) ? until : 0);
  var y = $m_sr_ScalaRunTime$().array$undlength__O__I(reprVal);
  var hi = ((x < y) ? x : y);
  var x$1 = ((hi - lo) | 0);
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
$e.TreeBuilderAndEvaluator = $m_LTreeBuilderAndEvaluator$();
$m_LTreeBuilderAndEvaluator$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
